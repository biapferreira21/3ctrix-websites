...
import { services, servicesNote } from "@/config/websites-en/services";
...
function ServiceCard({
  ...
  return (
    <Link
      href={`/websites/en/pricing#${id}`}
      aria-label={`Learn more sobre ${title}`}
      onMouseMove={onMove}
  ...
  return (
    <section id="servicos" className="relative overflow-hidden bg-[#f4f0e7] py-24 sm:py-28">
      ...
      <Container className="relative">
        <SectionHeading
          eyebrow="Services"
          title="A stronger digital presence, from start to finish."
        />
        ...
        <FadeIn className="mt-12 flex flex-col items-center gap-6 text-center">
          ...
          <Button href="/websites/en/pricing" variant="secondary">
            View pricing
          </Button>
        </FadeIn>
      </Container>
