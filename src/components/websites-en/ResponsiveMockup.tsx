...
export function ResponsiveMockup() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-xl pb-12">
      ...
      <FloatChip label="Responsive" className="-right-2 -top-3" delay={0} tone="green" />
      <FloatChip label="Fast" className="-left-3 top-1/3" delay={1.2} tone="purple" />
      <FloatChip label="Accessible" className="bottom-1 left-[42%]" delay={2.1} tone="gold" />
    </div>
  );
}
