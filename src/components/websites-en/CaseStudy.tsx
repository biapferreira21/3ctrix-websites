...
import { caseStudy } from "@/config/websites-en/content";
  ...
  return (
    <section id="projetos" className="relative overflow-hidden bg-[#f4f0e7] py-24 sm:py-28">
      ...
      <Container className="relative">
        <SectionHeading eyebrow="Case study" title={caseStudy.sectionTitle} />
