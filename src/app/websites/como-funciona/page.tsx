...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/websites/como-funciona", languages: { "pt-PT": "/websites/como-funciona", en: "/websites/en/how-it-works" } },
};
          ...
          <Container>
            <FadeIn className="relative mx-auto max-w-2xl rounded-[1.7rem] border-[3px] border-night bg-white p-8 shadow-[7px_7px_0_#9985DC]">
              ...
              <p className="mt-3 text-slate">
                Request a free review e receba as primeiras oportunidades de
                melhoria.
              </p>
              <div className="mt-6 flex justify-center gap-3">
                <Button href="/websites#contacto" size="lg">
